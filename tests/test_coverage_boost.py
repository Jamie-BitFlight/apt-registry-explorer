...
from apt_registry_explorer.cli import ArchitectureLister, OutputFormat, PackageQuerier, SourceParser, RepositoryExplorer
...
class TestSourceParserMethods:
    ...
    def test_parse_source_url_only(self):
...
class TestRepositoryDiscoveryMethods:
    ...
    def test_list_directory_with_files(self, mock_client_class):
    ...
    @patch("apt_registry_explorer.discovery.httpx.Client")
    def test_find_release_file_inrelease(self, mock_client_class):
    ...
    @patch("apt_registry_explorer.discovery.httpx.Client")
    def test_find_release_file_release(self, mock_client_class):
    ...
    @patch("apt_registry_explorer.discovery.httpx.Client")
    def test_get_architectures(self, mock_client_class):
...
"""
    ...
    @patch("apt_registry_explorer.discovery.httpx.Client")
    def test_navigate(self, mock_client_class):
...
class TestPackageIndexMethods:
    ...
    def test_filter_by_name_empty_result(self):
    ...
    def test_filter_by_regex_match(self):
    ...
    def test_filter_by_version_invalid_operator(self):
...
class TestSourcesBuilderMethods:
    ...
    def test_parse_deb_line_with_options(self):
        """Test parsing deb line with options."""
        builder = SourcesBuilder()
        result = builder.parse_deb_line("deb [arch=amd64 signed-by=/usr/share/keyrings/test.gpg] http://example.com/repo stable main")
