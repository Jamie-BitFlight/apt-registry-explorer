...
class TestPackageBrowserApp:
    ...
    def test_app_initialization(self, sample_packages) -> None:
    ...
    def test_compose_creates_widgets(self, sample_packages) -> None:
    ...
    def test_on_mount_populates_table(self, sample_packages) -> None:
    ...
    def test_on_data_table_row_selected_updates_details(self, sample_packages) -> None:
    ...
    def test_format_details_with_all_fields(self, sample_packages) -> None:
        """Test formatting package details with all fields present."""
        app = PackageBrowserApp(sample_packages)
        pkg = sample_packages[0]
        
        details = app._format_details(pkg)
    ...
    def test_format_details_with_missing_fields(self) -> None:
    ...
    def test_on_data_table_row_selected_with_invalid_key(self, sample_packages) -> None:
        ...
        try:
            ...
            # Expected behavior if index is invalid
            pass
